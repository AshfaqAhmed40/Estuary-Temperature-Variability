...
set(gcf, 'Position', [-1064,721,541,582]);
...
nexttile
%[~, hContour]=contourf(LON,LAT,flip(finaleeof2s).*U2(511,1),50,'edgecolor','none');
...
% Plot the EOF3
nexttile
%[~, hContour]=contourf(LON,LAT,flip(finaleeof3s).*U3(534,1),50,'edgecolor','none');
...
c.FontWeight = 'bold'; 
c.Layout.Tile = 'east';
set(gcf, 'Position', [-1993,720,928,583]);
...
% for i = 1:30
% nexttile
% [~, hContour]=contourf(LON,LAT,flip(finaleeof3s).*U3(i,1),50,'edgecolor','none');
